...
pub mod solquad {
    ...
    pub fn initialize_project(ctx: Context<InitializeProject>, name: String) -> Result<()> {
        ...
        project_account.is_in_pool = false; // // Initialize as false
    ...
    pub fn add_project_to_pool(ctx: Context<AddProjectToPool>) -> Result<()> {
        ...
        project_account.is_in_pool = true; // Mark as added to the pool
...
pub struct Project {
    ...
    pub is_in_pool: bool, // // New field to check if project is in a pool
